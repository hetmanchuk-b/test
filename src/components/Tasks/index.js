            ...
            <Fragment>
                ...
                <main className="main">
                    <div className="page-text-description">
                        <p>Сервис "Лист ожидания" предназначен для покупки билетов тогда, когда их уже нет в
                            продаже.</p>
                        <p>У вас есть возможность выбрать необходимую дату и временной диапазон отправления, желаемые
                            классы обслуживания, пассажиров, для которых необходимо приобрести билеты и оставить заявку
                            на оформление билетов.</p>
                        {this.state.textReadMore ? (
                            <React.Fragment>
                                <p>Как только наш ресурс "увидит" свободные места, соответствующие выбранным вами
                                    параметрам, произойдет автоматическое оформление. Билеты будут направлены вам на
                                    почту.</p>
                                ...
                                <div className="desc-info__item">
                                    ...
                                    <div className="input-icon date_wrapper">
                                        <DatePicker className={date ? "form__datepicker opened" : "form__datepicker"}
                                                    onChange={date => this.handleSet('date', date)} value={date}
                                                    minDate={dateNow} maxDate={dateNextYear}/>
                                    </div>
                                </div>
                                <div className="desc-info__item">

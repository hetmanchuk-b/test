                                        ...
                                        <div className="row header__search">
                                            <div className="col-lg-3 col-sm-6 col-parent col-item">
                                                <Select
                                                    ...
                                                    ref={this.fromRef}
                                                />
                                                <div className="swap"><a href="#"
                                                                         onClick={event => this.handleDestinationSwap(event)}
                                                                         className="swap-btn"><img
                                                    src="img/icons/search-arrows.png" alt=""/></a></div>
                                            </div>
                                            ...
                                            <div className="col-lg-3 col-sm-6 col-item">
                                                ...
                                                <DatePicker
                                                    className={dateFrom ? "small-datepicker show" : "small-datepicker"}
                                                    onChange={date => this.handleSet('dateFrom', date)} value={dateFrom}
                                            ...
                                            <div className="col-lg-3 col-sm-6 col-last col-item">
                                                ...
                                                <DatePicker
                                                    className={dateTo ? "small-datepicker show" : "small-datepicker"}
                                                    onChange={date => this.handleSet('dateTo', date)} value={dateTo}

										...
										<div id="accordion-general">
											<div className="card">
												...
												<div id="card-general-1" aria-labelledby="headingOne" data-parent="#accordion"
													...
													<div className="card-body">
														<h4 className="card-body__heading">Когда билет есть:</h4>
														<ol className="ordered-list">
															<li>Выберите поезд и место в вагоне.</li>
															<li>Введите данные пассажиров и отправьте заказ в корзину.</li>
															<li>Оплатите билет банковской картой.</li>
															<li>На экране появится билет.</li>
															<li>На Вашу почту придет билет.</li>
															<li>Стоимость оформления билета от 312р. +2,0%.</li>
															<li>Или 13% при стоимости билета свыше 10 000 р.</li>
														</ol>
														<hr />
														<h4 className="card-body__heading">Когда билета нет:</h4>
														<ol className="ordered-list">
															<li>Воспользуйтесь сервисом Лист Ожидания, он доступен из Личного Кабинета с</li>
															<li>привязанной банковской картой.</li>
															<li>Выберите поезд, на который Вам нужен билет.</li>
															<li>Введите данные пассажиров и отправьте заказ в корзину.</li>
															<li>Наш сервис подберет билет.</li>
															<li>Когда билет найдется, мы автоматически оплатим его, с Вашей привязанной карты и на
																Вашу почту придет билет.</li>
															<li>Стоимость оформления билета от 300р.</li>
															<li>Сервис доступен круглосуточно.</li>
														</ol>
													</div>
												</div>
											</div>
												...
												<div id="card-general-2" className="collapse" aria-labelledby="headingOne" data-parent="#accordion"
													...
													<div className="card-body">
														<ul className="unordered-list">
															...
															<li>Оплата банковской картой производится через платежный шлюз ПАО &quot;Сбербанк России&quot;,
																PayAnyWay, Яндекс.Деньги.</li>
															<li>Соединение с платежным шлюзом и передача информации
																использованием протокола шифрования SSL.</li>
															<li>Оплата банковской картой производится только после подтверждения бронирования билета на ваше имя.</li>
															<li>При оплате банковской картой общая сумма увеличивается на 2,0%.</li>
															<li>Успешная оплата проходит только картами Visa, MasterCard, МИР с 3Ds.</li>
														</ul>
														<hr />
														<h4 className="card-body__heading">Порядок оплаты билета</h4>
														<ol className="ordered-list">
															<li>Банковскими картами Visa, MasterCard, МИР, JCB онлайн.</li>
															<li>Выберите поезд и место в вагоне, заполните данные пассажиров. Для оплаты введите данные банковской
																карты, введите код 3D-security, полученный в СМС от вашего банка.</li>
															<li>В случае успешной оплаты через несколько секунд отобразится ваш электронный билет и
																на ваш email придет такой же билет.</li>
															<li>Распечатайте и предъявите его при посадке в поезд, вместе с документом указанным в билете.</li>
															<li>При возврате билета деньги за вычетом комиссий вернутся на вашу карту.</li>
														</ol>
													</div>
												</div>
											</div>
											...
											<div className="card">
												...
												<div id="card-general-4" className="collapse" aria-labelledby="headingOne" data-parent="#accordion"
													...
													<div className="card-body">
														<ol className="ordered-list">
															<li>Перейдите по ссылке в письме с билетами, чтобы отказаться от билетов.</li>
															<li>Введите номер сдаваемого билета.</li>
															<li>На ваш email придет подтверждение о сдаче билета.</li>
															<li>Комиссии РЖД при возврате билета</li>
															<li>Билеты на поезда внутри России</li>
															<li>При возврате билета взимается сбор в размере 212 руб. за каждое место.</li>
															<li>Сумма возврата зависит от времени сдачи билета до отправления поезда:</li>
															<li>- не позднее, чем за 8 часов до отправления полная стоимость проезда;</li>
															<li>- от 2 до 8 часов до отправления стоимость билета и 50% стоимости плацкарты;</li>
															<li>- менее чем за 2 часа до отправления только стоимость билета. Стоимость плацкарты не возвращается;</li>
															<li>- при опоздании на поезд в течение 12 часов после отправления, либо вследствие болезни / несчастного случая (при наличии подтверждающих документов) в течение 5 суток с момента отправления поезда только стоимость билета. Стоимость плацкарты не возвращается.</li>
														</ol>
														<hr />
														<h4 className="card-body__heading">Комиссии сервиса при возврате билета:</h4>
														<ul className="unordered-list">
															<li>При возврате билета сервисные сборы и суммы комиссий банков не возвращаются.</li>
															<li>Возврат денег за билеты производится на банковскую карту, с которой была произведена покупка билета, в течение одного рабочего дня с момента поступления сумм возврата от РЖД.</li>
															<li>Возврат средств от РЖД может занять 30 дней. Из практики, РЖД перечисляет деньги в течение 7 дней.</li>
														</ul>
														<hr />
														<h4 className="card-body__heading">Сроки возврата электронного билета с пройденной электронной регистрацией:</h4>
														<ul className="unordered-list">
															<li>От времени сдачи билета зависит процедура возврата билета и сроки возврата денег на вашу карту.</li>
															<li>Если сдаете билет не менее чем за 1 час до отправления поезда с начальной станции отправления поезда, то деньги вернутся быстро.</li>
															<li>Если сдаете билет менее чем 1 час до отправления поезда и не более 20 минут после отправления поезда, то нужно писать заявление и деньги вернутся не раньше чем через 30 дней.</li>
															<li>Если сдаете билет в период с 20 минут до 3 часов на станции отправления поезда, то деньги вернутся от 7 до 30 дней.</li>
															<li>Если вы опоздали на поезд (не воспользовались билетом), то билет можно сдать только на станции посадки пассажира не позднее 12 часов после отправления поезда со станции посадки пассажира.</li>
														</ul>
													</div>
												</div>
											</div>
											<div className="card">
												...
												<div id="card-general-5" className="collapse" aria-labelledby="headingOne" data-parent="#accordion"
													...
													<div className="card-body">
														<h4 className="card-body__heading">Стоимость услуг</h4>
														<ul className="unordered-list">
															<li>При стоимости билета 3 999 рублей, включительно - стоимость услуг по оформлению каждого билета составляет 312 рублей + 2,0% от стоимости всего заказа.</li>
															<li>При стоимости билета от 4 000 рублей до 5 999 рублей, включительно - стоимость услуг по оформлению каждого билета составляет 402 рубля + 2,0% от стоимости всего заказа.</li>
															<li>При стоимости билета от 6 000 рублей до 9 999 рублей, включительно - стоимость услуг</li>
															<li>по оформлению каждого билета составляет 522 рубля + 2,0% от стоимости всего заказа.</li>
															<li>При стоимости билета 10 000 рублей и более - стоимость услуг составляет 12% от стоимости билетов.</li>
														</ul>
														<hr />
														<ul className="unordered-list">
															<li>Найти билет/Лист Ожидания – 1000 рублей + 2.0% от стоимости заказа.</li>
															<li>Если билета на нужный Вам поезд нет в наличии, то мы будем его искать и сразу же купим его для Вас, для этого Вам необходимо воспользоваться сервисом Лист Ожидания после входа/регистрации в Личном Кабинете, привязав банковскую карту с суммой положительного баланса на ней равную, либо выше стоимости билета с учетом стоимости услуги подбора и оформления билета, а так же комиссии банка. Услуга предоставляется не позднее чем за 1 час до отправления поезда.</li>
														</ul>
													</div>
												</div>
											</div>

      ...
      <div className="search-result__info d-flex j-content-between">
        <div className="list">
            ...
            <div className="list__content d-flex j-content-between">
                <div className="list__item__wrap flex-column">
                    ...
                    <div className="d-flex">
                        <div className={this.serviceClassName('economy', '2Р')}
                             onClick={this.serviceClassToggle('economy', '2Р')}>
                            ...
                            <div className="icon-wrap j-content-center">
                                <img className="list__item__icon" src="img/icon_1.png" alt=""/>
                                <img className="list__item__icon" src="img/icon_2.png" alt=""/>
                            </div>
                        ...
                        <div className={this.serviceClassName('economy', '2В')}
                             onClick={this.serviceClassToggle('economy', '2В')}>
                            <div className="top-link d-flex align-items-center j-content-center">
                            ...
                            <div className="icon-wrap j-content-center">
                                <img className="list__item__icon" src="img/icon_1.png" alt=""/>
                                <img className="list__item__icon" src="img/icon_2.png" alt=""/>
                                <img className="list__item__icon" src="img/icon_3.png" alt=""/>
                            </div>
                            <div className="bottom-box">
                                <div className="price">
                                    от&nbsp;
                        ...
                        <div className={this.serviceClassName('economy', '2С')}
                             onClick={this.serviceClassToggle('economy', '2С')}>
                            <div className="top-link d-flex align-items-center j-content-center">
                        ...
                        <div className={this.serviceClassName('economy', '2Е')}
                             onClick={this.serviceClassToggle('economy', '2Е')}>
                            <div className="top-link d-flex align-items-center j-content-center">
                        ...
                        <div className={this.serviceClassName('economy', '2Ю')}
                             onClick={this.serviceClassToggle('economy', '2Ю')}>
                            <div className="top-link d-flex align-items-center j-content-center">
                        ...
                        <div className={this.serviceClassName('economy', '2Я')}
                             onClick={this.serviceClassToggle('economy', '2Я')}>
                            <div className="top-link d-flex align-items-center j-content-center">
                        ...
                        <div className={this.serviceClassName('economy', '1Ж')}
                             onClick={this.serviceClassToggle('economy', '1Ж')}>
                            <div className="top-link d-flex align-items-center j-content-center">
                ...
                <div className="list__item__wrap flex-column">
                    <div className="list__head d-flex j-content-center">
                    ...
                    <div className="d-flex">
                        <div className={this.serviceClassName('business', '1С')}
                             onClick={this.serviceClassToggle('business', '1С')}>
                            <div className="top-link d-flex align-items-center j-content-center">
                            ...
                            <div className="icon-wrap j-content-center">
                                ...
                                <img className="list__item__icon" src="img/icon_2.png" alt=""/>
                                <img className="list__item__icon" src="img/icon_3.png" alt=""/>
                                <img className="list__item__icon" src="img/icon_4.png" alt=""/>
                            </div>
                ...
                <div className="list__item__wrap flex-column">
                    ...
                    <div className="d-flex">
                        <div className={this.serviceClassName('premium', '1В')}
                             onClick={this.serviceClassToggle('premium', '1В')}>
                            <div className="top-link d-flex align-items-center j-content-center">
                            ...
                            <div className="icon-wrap j-content-center">
                                ...
                                <img className="list__item__icon" src="img/icon_3.png" alt=""/>
                                <img className="list__item__icon" src="img/icon_4.png" alt=""/>
                                <img className="list__item__icon" src="img/icon_5.png" alt=""/>
                                <img className="list__item__icon" src="img/icon_6.png" alt=""/>
                                <img className="list__item__icon" src="img/icon_7.png" alt=""/>
                            </div>
                        ...
                        <div className={this.serviceClassName('premium', '1Р')}
                             onClick={this.serviceClassToggle('premium', '1Р')}>
                            <div className="top-link d-flex align-items-center j-content-center">
